...
type RequestRow = {
  ...
  vlog_consent: boolean; vlog_blur_preference: HomeServiceRequest["vlogBlurPreference"]; screen_quality: HomeServiceRequest["screenQuality"]; reminder_sent_at: Date | null;
};
function mapRequest(r: RequestRow): HomeServiceRequest {
  return {
    ...
    vlogConsent: r.vlog_consent, vlogBlurPreference: r.vlog_blur_preference || "", screenQuality: r.screen_quality || "", reminderSentAt: toIsoOrNull(r.reminder_sent_at),
  };
}
